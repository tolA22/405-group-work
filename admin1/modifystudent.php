...
if(isset($_POST["modifyStudentBtn"])){
	if(isset($_POST["s_firstname"])&&isset($_POST["s_lastname"])&&isset($_POST["s_password"])&&isset($_POST["s_matricnumber"])&& isset($_POST["s_phonenumber"])&& isset($_POST["s_mail"]) && isset($_POST["s_department"])&& isset($_POST["s_faculty"])&& isset($_POST["s_address"])){
		include("database.php");
	$query = "UPDATE Student SET s_firstname='".$_POST["s_firstname"]."',s_lastname='".$_POST["s_lastname"]."', s_password='".$_POST["s_password"]."',s_phonenumber='".$_POST["s_phonenumber"]."', s_mail='".$_POST["s_mail"]."',s_department='".$_POST["s_department"]."',s_faculty='".$_POST["s_faculty"]."',s_address='".$_POST["s_address"]."' WHERE s_matricnumber='".$_POST["s_matricnumber"]."'";
...
$s_matricnumber = $_POST["s_matricnumber"];
...
echo '
							...
							<li class="breadcrumb-item " >
								<a  href="viewstudent.php?view='.$s_matricnumber.'">'.$s_firstname." " .$s_lastname.'</a>
							</li>
							<li class="breadcrumb-item active
							" >
								<a class="active" href="modifystudent.php?modify='.$s_matricnumber.'">Modify</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div  class="col-12 ">
						...
						<div  class="row supervisorSmallBox">
							...
							<div style="background-color: purple; height:  50px" class="row">
									...
									<div  class="row">	
										<div class="col-12">	
											<form  action="modifystudent.php?modify='.$s_matricnumber.'" method="post">
												<div class="row"> 
													<div class="col-6">
												...
												<div class="row"> 
													...
													<input style="border-top: 0; border-left: 0; border-right: 0; height: 35px; width: 300px; border-bottom-color: purple; background-color: ghostwhite " type="text" name="s_matricnumber" required="" value="'.$s_matricnumber.' "readonly="">	
												</div>
													</div>	
													<div class="col-6">
														<div class="form-group">
												...
												<div class="row"> 
													...
													<input style="border-top: 0; border-left: 0; border-right: 0; height: 35px; width: 300px; border-bottom-color: purple; background-color: ghostwhite " type="email" name="s_mail" required="" value="'.$s_mail.'" >	
												</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col ">
														<input class="float-right" style="text-align:center; color: white; background-color: purple; height: 50px " type="submit" name="modifyStudentBtn" value="MODIFY '.$s_firstname.' '.$s_lastname.'" >
													</div>
												</div>
