...
echo '
							...
							" >
								<a class="active" href="viewsupervisor.php?view='.$s_staffnumber.'">'.$s_firstname." " .$s_lastname.'</a>
							</li>
						</ul>
					</div>
				</div>
						...
						<div  class="row supervisorSmallBox">
							...
							<div style="background-color: white;" class="row">
										<div style="color: black;text-align:center; " class="col-12">
											...
											<div class="row" >
												<div class="col">
													<h5 style ="color: gray;font-weight:lighter; "> EXAMINER</h5>
												</div>
											...
											<div style="color: black;text-align:center; " class="row" >
												<div style="text-align:right; " class="col-5">
													<h4>StaffNumber: '.$s_staffnumber.'</h4>
												</div>
												<div class="col-5 col-offset-2">
											...
											<div style="margin-top:6%;text-align:center;" class="row">
												<div class="col" >
													<a href="modifysupervisor.php?modify='.$s_staffnumber.'"><button style="color:white; background-color:orangered; border-radius:3%; width:40%;" class="btn">
														<img style="display:inline-block; float:left; width:7%" src="img/edit.svg" alt="img ">
														<h6 style="text-align:center;">MODIFY EXAMINER</h6>
													</button></a>
												</div>
											</div>
